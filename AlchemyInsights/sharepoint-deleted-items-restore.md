...
- [Taasta kustutatud saidikogum (sh rühm, suhtlus ja muud saidid)](https://docs.microsoft.com/sharepoint/restore-deleted-site-collection ).

- [Kustutatud OneDrive ' i taastamine](https://docs.microsoft.com/onedrive/restore-deleted-onedrive)

- [SharePoint Online ' i PNP](https://docs.microsoft.com/powershell/sharepoint/sharepoint-pnp/sharepoint-pnp-cmdlets?view=sharepoint-ps)
