...
ms.locfileid: "50694143"
---
# <a name="install-deploy-and-configure-mdatp-on-a-mac"></a>MDATP installimine, juurutamine ja konfigureerimine Mac-arvutis

MDATP saate juurutada [käsitsi](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/mac-install-manually) või tööriistaga juhtimine.
...
Lisateavet leiate teemast [MDATP installimine Mac-arvutisse](https://go.microsoft.com/fwlink/?linkid=2144672)
