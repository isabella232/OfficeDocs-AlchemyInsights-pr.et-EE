...
ms.locfileid: "53999776"
---
# <a name="import-contacts"></a>Kontaktide importimine

Enne kontaktide importimist Outlooki veebirakendus peate need teise meiliteenuse pakkujalt eksportima .csv. Seejärel järgige allolevaid juhiseid.
 ...
 **Inimesed**.
2. Valige tööriistaribal Halda **kontaktide**  >  **importimist**.
3. Valige **Sirvi**, valige csv-fail ja seejärel valige **Ava**.
4. Valige **Impordi**.

Lisateavet leiate teemast Kontaktide [importimine Outlook](https://support.office.com/article/bb796340-b58a-46c1-90c7-b549b8f3c5f8#ID0EAACAAA=Outlook_on_the_web).
