...
- Avage turvalisuse ja vastavuse > andmete juhtimine > säilitamine
  - Vaata [seda](https://docs.microsoft.com/microsoft-365/compliance/retention-policies) artiklit

- jaotisse turvalisus ja vastavus > eDiscovery> Täpsem eDiscovery 
  - Vaata [seda](https://docs.microsoft.com/microsoft-365/compliance/ediscovery-cases) artiklit

- Avage turvalisuse ja vastavuse > liigitused > säilitamine
  - Vaata neid artikleid
    - [Tundlikkuse Sildid](https://docs.microsoft.com/microsoft-365/compliance/sensitivity-labels)
