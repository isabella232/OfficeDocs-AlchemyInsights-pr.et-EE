---
title: Alkeemia tekstisiseste piltide testimine
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "47669388"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="9f92c-102">Juurdepääs domeenide lehele</span><span class="sxs-lookup"><span data-stu-id="9f92c-102">Access the Domains Page</span></span>

<span data-ttu-id="9f92c-103">Lehel domeenid juurdepääsemiseks klõpsake lihtsalt allolevat ikooni:</span><span class="sxs-lookup"><span data-stu-id="9f92c-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="9f92c-104">Seejärel saate domeeni lisada, muuta või eemaldada.</span><span class="sxs-lookup"><span data-stu-id="9f92c-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="9f92c-105">Lisateavet leiate teemast [domeenide KKK.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="9f92c-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
