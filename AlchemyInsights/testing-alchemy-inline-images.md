---
title: Testimine Alchemy tekstisiseseid pilte
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "44505051"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="0bec4-102">Juurdepääs domeenide lehele</span><span class="sxs-lookup"><span data-stu-id="0bec4-102">Access the Domains Page</span></span>

<span data-ttu-id="0bec4-103">Domeenide lehele juurdepääsuks klõpsake seda ikooni allpool:</span><span class="sxs-lookup"><span data-stu-id="0bec4-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="0bec4-104">Seejärel saate oma domeeni lisada, muuta või eemaldada.</span><span class="sxs-lookup"><span data-stu-id="0bec4-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="0bec4-105">Lisateabe saamiseks vaadake [DOMEENIDE KKK.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="0bec4-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
