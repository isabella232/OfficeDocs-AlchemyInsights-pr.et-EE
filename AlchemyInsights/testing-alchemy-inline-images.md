...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="ac689-102">Juurdepääs domeenide lehele</span><span class="sxs-lookup"><span data-stu-id="ac689-102">Access the Domains Page</span></span>

<span data-ttu-id="ac689-103">Domeenide lehele juurdepääsuks klõpsake seda ikooni allpool:</span><span class="sxs-lookup"><span data-stu-id="ac689-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="ac689-104">Seejärel saate oma domeeni lisada, muuta või eemaldada.</span><span class="sxs-lookup"><span data-stu-id="ac689-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="ac689-105">Lisateabe saamiseks vaadake [DOMEENIDE KKK.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="ac689-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
