...
---
# <a name="sharepoint-online-site-management"></a>SharePoint Online ' i Saidihaldus

Siin on mõned korduma kippuvad teemad SharePoint Online ' i saidi haldamine:

- [Saitide haldamine](https://docs.microsoft.com/sharepoint/manage-sites-in-new-admin-center)
- [Saidi Salvestuspiirangute haldamine](https://docs.microsoft.com/sharepoint/manage-site-collection-storage-limits)
