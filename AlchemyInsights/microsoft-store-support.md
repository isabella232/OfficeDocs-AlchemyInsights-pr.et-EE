...
---
# <a name="microsoft-store-support"></a>Microsofti poe tugi

Me kuulame ja tahame aidata. Kui vajate abi toote ostu, tellimuse oleku, arveldusega seotud probleemide, eripakkumiste, toote teabe või Microsofti poe toe kohta teabe otsimisel, lugege teemat [Microsofti poe toe poole pöördumine](https://support.microsoft.com/account-billing/contact-microsoft-store-support-4f615f2a-6bbd-fd69-6695-ae213d63eef0).

Lisateavet äsja väljastatud seadmete või Microsofti tulevaste toodete kohta leiate teemast [Microsofti pood](https://www.microsoft.com/?ql=1).
