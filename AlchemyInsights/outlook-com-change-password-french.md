...
2. Par mesure de sécurité, Vous pouvez être invité à kinnitaja Votre identité à l ' aide d ' un kood de sécurité.
3. Entrez Votre MOT de passe Actuel, Votre Nouveau MOT de passe, PUIS sélectionnez **Enregistrer**.

Si Vous avez oublié Votre MOT de passe, accédez à la [Page de réinitialiseerimine de MOT de passe de Compte Microsoft](https://go.microsoft.com/fwlink/p/?linkid=841909), PUIS suivez Les kutsub.
