...
---
# <a name="sharing-and-permission-methods-to-provide-or-restrict-user-access-to-sharepoint-site"></a>Ühiskasutuse ja lubade meetodid SharePointi saidile kasutaja juurdepääsu pakkumiseks või piiramiseks

Pärast SharePointi saidi loomist võiksite anda või piirata kasutaja juurdepääsu saidile või selle sisule. Seda saab teha erinevate jagamise ja loa meetodite abil allpool.
...
- [Lingi vaiketüübi muutmine, kui kasutajad saavad linke ühiskasutusse](https://docs.microsoft.com/sharepoint/change-default-sharing-link)
