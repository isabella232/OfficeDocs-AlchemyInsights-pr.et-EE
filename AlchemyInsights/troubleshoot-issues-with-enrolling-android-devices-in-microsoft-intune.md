...
2. Nimekiri kõige sagedasemad vead, mis takistavad registreerimine ja lahendused igale [dokumendi](https://docs.microsoft.com/en-us/intune-classic/Troubleshoot/troubleshoot-device-enrollment-in-intune) läbivaatamiseks. 
    
3. [Kuidas registreeruda Microsoft Intune Androidiga](https://docs.microsoft.com/en-us/intune/android-enroll).
