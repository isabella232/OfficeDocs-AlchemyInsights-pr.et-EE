...
ms.locfileid: "51815395"
---
# <a name="enable-seamless-sso"></a>Sujuva SSO lubamine

Azure Active Directory (Azure AD) Sign-On (sujuv SSO) logib kasutajad automaatselt sisse, kui nad on teie ettevõtte võrku ühendatud ettevõtte töölaual.
