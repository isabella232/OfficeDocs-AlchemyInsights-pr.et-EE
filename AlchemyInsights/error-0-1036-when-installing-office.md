...
---
# <a name="error-0-1036-when-installing-office"></a>Tõrge 0-1036 Office'i installimisel


Proovige määrata oma Office viga 0-1036 järgmisi võimalusi:
  
- Taaskäivitage arvuti ja proovige uuesti [Office installida](https://portal.office.com/OLS/MySoftware.aspx) . 
    
- Laadida ja installida [toetust ja taastamise abimees](https://aka.ms/SARA-OfficeUninstall-Alchemy).
    
1. Avamisel, **Desinstallige Office** toodetest valida versiooni desinstallida ning valige **Järgmine**.
