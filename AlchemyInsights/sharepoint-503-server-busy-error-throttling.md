...
See tõrge võib põhjustada ahendamine jooksul SharePointi teenus. SharePoint Online ' i kasutab ahendamine optimaalse jõudluse ja töökindluse SharePoint Online Service. Ahendamine piirab kasutajate toimingute või samaaegsete kõnede (skripti või koodi) arvu, et vältida ressursside ülekasutamist. Kui te saate ahendada, 99% ajast see on kohandatud koodi tõttu.
