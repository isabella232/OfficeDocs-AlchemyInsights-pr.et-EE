...
Kohta lisateabe saamiseks lugege [Kuidas Office'i rakenduste ja teenuste toeta Azure Rights Management](https://docs.microsoft.com/azure/information-protection/understand-explore/office-apps-services-support).

[Seada üles teabeõiguste halduse (IRM) SharePointi administreerimiskeskuses](https://docs.microsoft.com/en-us/office365/securitycompliance/set-up-irm-in-sp-admin-center).
